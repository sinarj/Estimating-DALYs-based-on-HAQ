...
# detailed locations (age-group specific)
##########################################################
...
amenabledf_2017<-fread(paste0(data_dir,"combined_data/global_data" ,"/allMostDet_data_noncancer.csv"))
...
amenabledf_2017_MI_ratios <-fread(paste0(data_dir,"combined_data/global_data" ,"/allMostDet_data_cancer.csv"))
...
write.csv(index2016_all, file = paste0(data_dir, "/results/haq_2016_bycauseage_allMostDetLocs.csv"))
#also making a local copy on my drive
write.csv(index2016_all, file = paste0("/ihme/homes/arjuns13/notebooks/Documents/Data/haq_2016_bycauseage_allMostDetLocs.csv"))

#now the aggregated cause with cause_id=100
index2016_agg <-indexdf[year_id==2016][cause_id==100]
write.csv(index2016_agg, file = paste0(data_dir, "/results/haq_2016_by_allcause_age_allMostDetLocs.csv"))
#also making a local copy on my drive
write.csv(index2016_agg, file = paste0("/ihme/homes/arjuns13/notebooks/Documents/Data/haq_2016_by_allcause_age_allMostDetLocs.csv"))